...
print("The average heart rate over the last hour is: \(averageHR)")
...
print("The average heart rate over the last hour is: \(averageHRD)") // Print the average heart rate to the console
...
print("The percentage of the daily goal that has been achieved so far is: \(percentOfGoal)%")
