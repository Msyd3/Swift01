...
let roomArea = area / 2
print("Each room will have an area of \(roomArea) square feet.")
...
print("The perimeter of the shed is \(perimeter) feet.")
...
print("The remainder of dividing \(even) by 2 is: \(evenRemainder)") 
print("The remainder of dividing \(odd) by 2 is: \(oddRemainder)")
